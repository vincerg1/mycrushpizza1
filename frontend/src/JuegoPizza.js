  ...
  const intentarGanar = async () => {
    ...
    try {
      ...
      if (res.data.esGanador) {
        ...
        // pero no abrimos el modal de bloqueo sobre el modal de reclamo.
        if (res.data.lockedUntil) {
          setLockedUntil(res.data.lockedUntil);
          setUltimoNumeroGanado(res.data.numeroGanador);
        }
        // Resetea estados de cupón por si se ganó de nuevo luego
        setCoupon(null);
        setCouponError(null);
    ...
    <div className="container">
      ...
      {showCookies && (
        <div className="cookie-banner">
          <span>
            Usamos cookies para análisis y personalización. Puedes aceptarlas o
            rechazar las no esenciales. Más info en nuestra&nbsp;
          ...
          <div className="cookie-actions">
            <button className="btn-cookies no" onClick={rechazarCookies}>
              Rechazar
            </button>
